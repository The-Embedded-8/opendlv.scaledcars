        ...
        odcore::data::dmcp::ModuleExitCodeMessage::ModuleExitCode Overtaker::body() {
            ...
            while (getModuleStateAndWaitForRemainingTimeInTimeslice() == odcore::data::dmcp::ModuleStateMessage::RUNNING) {
                ...
                if (stageMoving == FORWARD) {
                    ...
                    std::cout << "TO_LEFT_LANE_LEFT_TURN" << endl;
			...
			stageToRightLaneLeftTurn++;
                    ...
                    std::cout << "TO_LEFT_LANE_RIGHT_TURN" << endl;
                    ...
                    std::cout << "CONTINUE_ON_LEFT_LANE" << endl;
                    ...
                    std::cout << "TO_RIGHT_LANE_RIGHT_TURN" << endl;
                }
                    ...
                    std::cout << "TO_RIGHT_LANE_LEFT_TURN" << endl;
                }
